...
import cn.zhusaidong.bytecode.parser.structure.data.constant.ConstantPoolFieldRefInfo;
 ...
 * @since 2024/1/24
 */
public class ConstantPoolFieldRefParser implements ConstantParser<ConstantPool> {
    @Override
    public ConstantPool parser(InputStream is, Object... objs) {
        return new ConstantPoolFieldRefInfo(ByteUtil.toDigits(ByteUtil.getBytes(is, 2)), ByteUtil.toDigits(ByteUtil.getBytes(is, 2)));
    }
}
