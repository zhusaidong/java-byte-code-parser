...
import cn.zhusaidong.bytecode.parser.structure.data.constant.ConstantPoolIntegerInfo;
 ...
 * @since 2024/1/24
 */
public class ConstantPoolIntegerParser implements ConstantParser<ConstantPool> {
    @Override
    public ConstantPool parser(InputStream is, Object... objs) {
        return new ConstantPoolIntegerInfo(ByteUtil.toDigits(ByteUtil.getBytes(is, 4)));
    }
}
